...
_______,LALT_T(KC_BSLS),LGUI_T(KC_MINS), LCTL_T(KC_SCLN), KC_EQL, KC_PERC,    KC_DLR, KC_PAST, KC_EXLM, KC_PIPE, RALT_T(KC_GRV), _______,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------+
      _______, KC_TILD, KC_UNDS, KC_COLN, KC_PLUS,   KC_AT,                   KC_HASH, KC_AMPR, RSG_T(KC_CIRC), KC_SLSH, TMUX_P, _______,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------+
      _______, TMUX_P_N, _______, LCTL_T(KC_PGUP), CTL_U, KC_HOME,          KC_LEFT, KC_DOWN,   KC_UP,KC_RIGHT, RALT_T(KC_F11), _______,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------+
      _______, _______, _______, KC_PGDN, CTL_D, KC_END,                      _______, _______, _______, _______, KC_F12, _______,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
